...
<body>
            ...
            <section class="col-md-3 sidebar" id="sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <li><a class="dropdown-item small-dropdown" href="ept3nouns.php" data-gif-key="Sorry">Nouns</a></li>
              ...
              <section class="container quiz-container">
                <div class="text-center mb-4">
                  <h1 class="quiz-title">Sign Language Quiz Alphabet: Part 1</h1>
                  <p class="lead">Test your knowledge of basic Letters in sign language gestures.</p>
                ...
                <div id="startButtonContainer" class="text-center mb-4">
                  ...
                  <div id="advancedQuizSection" style="display: none;" class="mt-4">
                    <div class="card border-success">
                      <div class="card-header bg-success text-white">
                        <h5 class="mb-0">
                          <i class="fas fa-star me-2"></i>Congratulations! You're Ready for Advanced Quizzes!
                        </h5>
                      </div>
                      <div class="card-body">
                        <p class="mb-3">Great job! You've shown excellent understanding of the basics. Now challenge yourself with our advanced sign language quizzes designed to test your mastery.</p>
                        <div class="d-flex gap-2">
                          <a href="advanced_quiz.php" class="btn btn-success">
                            <i class="fas fa-rocket me-2"></i>Take Advanced Quiz
                          </a>
                          <button class="btn btn-outline-secondary" onclick="retakeQuiz()">
                            <i class="fas fa-redo me-2"></i>Practice More
                          </button>
                        </div>
                      </div>
                    </div>
    ...
    <script src="js/ept1alphabet.js?v=<?php echo time(); ?>"></script>
