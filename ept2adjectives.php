...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="css/exercisepart2.css?v=<?php echo time(); ?>" rel="stylesheet">
</head>
...
<body>
            ...
            <section class="col-md-3 sidebar" id="sidebar">
              ...
              <section class="container quiz-container">
                <div class="text-center mb-4">
                  <h1 class="quiz-title">Sign Language Quiz Adjectives: Part 2</h1>
    ...
    <script src="js/ept2adjectives.js"></script>
