...
<body>
            ...
            <section class="col-md-3 sidebar" id="sidebar">
              ...
              <section class="container quiz-container">
                <div class="text-center mb-4">
                  <h1 class="quiz-title">Sign Language Quiz Greetings: Part 1</h1>
                  <p class="lead">Test your knowledge of basic Greetings in sign language gestures.</p>
    ...
    <script src="js/ept1greetings.js?v=<?php echo time(); ?>"></script>
