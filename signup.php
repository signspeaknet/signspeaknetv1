...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows > 0) {
        ...
        // Insert new user
        $stmt = $conn->prepare("INSERT INTO users (username, password, auth_provider) VALUES (?, ?, ?)");
        $stmt->bind_param("sss", $username, $hashed_password, $auth_provider);
...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="css/signup.css?v=<?php echo time(); ?>" rel="stylesheet">
</head>
      ...
      <div class="col-md-6 p-5">
        ...
        <form method="post" action="">
          ...
          <div class="mb-3 position-relative">
            <input type="password" class="form-control password-field" id="passwordInput" name="password" placeholder="Enter your Password" required>
          ...
          <div class="form-check mb-3">
            ...
            <label class="form-check-label" for="agreeCheck">
              I Agree with <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal">terms</a> and <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal">Privacy Policy</a>
            </label>
          </div>
...
<div class="modal fade" id="usernameTakenModal" tabindex="-1" aria-labelledby="usernameTakenLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-0">
        <h5 class="modal-title d-flex align-items-center gap-2" id="usernameTakenLabel">
          <span class="text-danger"><i class="fa-solid fa-circle-xmark fa-lg"></i></span>
          Username Already Taken
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body text-center pt-0">
        <p class="mb-2">That username is not available.</p>
        <p class="text-muted mb-0">Try a different username or add numbers/symbols.</p>
      </div>
      <div class="modal-footer border-0 d-flex justify-content-center">
        <button type="button" class="btn btn-outline-secondary w-100" data-bs-dismiss="modal">Okay</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="signupSuccessModal" tabindex="-1" aria-labelledby="signupSuccessLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-0">
        <h5 class="modal-title d-flex align-items-center gap-2" id="signupSuccessLabel">
      ...
      <div class="modal-body text-center pt-0">
        ...
        <p class="text-muted mb-0">You can now log in and start learning with SignSpeak.</p>
      </div>
      <div class="modal-footer border-0 d-flex justify-content-center">
...
<script>
document.addEventListener('DOMContentLoaded', function() {
  var modal = new bootstrap.Modal(document.getElementById('signupSuccessModal'));
  modal.show();
});
</script>
<?php endif; ?>
...
<script>
document.addEventListener('DOMContentLoaded', function() {
  var modal = new bootstrap.Modal(document.getElementById('usernameTakenModal'));
  modal.show();
});
</script>
<?php endif; ?>
