...
<body>
            ...
            <section class="col-md-3 sidebar" id="sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <li><a class="dropdown-item small-dropdown" href="ept2numbers.php" data-gif-key="Hello">Numbers</a></li>
                        <li><a class="dropdown-item small-dropdown" href="alphabet.php" data-gif-key="Goodbye">Alphabet</a></li>
                        <li><a class="dropdown-item small-dropdown" href="greetings.php" data-gif-key="Thank you">Greetings</a></li>
                        <li><a class="dropdown-item small-dropdown" href="verbs.php" data-gif-key="Please">Common Verbs</a></li>
                        <li><a class="dropdown-item small-dropdown" href="nouns.php" data-gif-key="Sorry">Nouns</a></li>
                        <li><a class="dropdown-item small-dropdown" href="adjectives.php" data-gif-key="Yes">Adjectives</a></li>
                        <li><a class="dropdown-item small-dropdown" href="questions.php" data-gif-key="Yes">Questions</a></li>
                        </ul>
                    </li>
              ...
              <section class="container quiz-container">
                <div class="text-center mb-4">
                  <h1 class="quiz-title">Sign Language Quiz Questions: Part 1</h1>
    ...
    <script src="js/ept1questions.js?v=<?php echo time(); ?>"></script>
