// question functionality for EPT1 Greetings //
...
window.onload = function() {
    fetch('questions_bank.json')
        .then(res => res.json())
        .then(data => {
            // Filter for EPT1 Greetings: quizID starts with 'A', category is 'greetings'
            const filtered = data.questions.filter(q => q.quizID.startsWith('A') && q.category === 'greetings');
