...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="css/exercisepart3.css?v=<?php echo time(); ?>" rel="stylesheet">
</head>
...
<body>
            ...
            <section class="col-md-3 sidebar" id="sidebar">
              ...
              <section class="container quiz-container">
                <div class="text-center mb-4">
                  <h1 class="quiz-title">Sign Language Numbers: Part 2</h1>
                  <p class="lead">Test your knowledge of basic Numbers in sign language gestures.</p>
                ...
                <form id="quizForm" style="display: none;">
                    ...
                    <div class="video-container mb-4">
                        <div class="reference-video">
                            <h5>Reference Gesture</h5>
                            <video id="referenceVideo" class="video-player" controls>
                        ...
                        <div class="recording-section">
                            ...
                            <video id="previewVideo" class="video-player" autoplay muted></video>
                            <div class="recording-controls">
                                <button type="button" class="btn btn-danger" id="startRecordingBtn">
                                    <i class="fas fa-record-vinyl"></i> Start Recording
                                </button>
                                <button type="button" class="btn btn-secondary" id="stopRecordingBtn" disabled>
                                    <i class="fas fa-stop"></i> Stop Recording
                                </button>
                                <button type="button" class="btn btn-info" id="playRecordingBtn" disabled>
                    ...
                    <div class="navigation-buttons d-flex flex-column flex-md-row justify-content-between gap-2">
                        ...
                        <button type="button" class="btn" id="submitBtn" onclick="checkAnswers()" style="display: none;">Submit Quiz</button>
                    </div>
                </form>
    ...
    <script src="js/ept3numbers.js"></script>
